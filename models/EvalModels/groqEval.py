...
DEFAULT_GROQ_MODEL = "mixtral-8x7b-32768"  # ✅ Default Groq model

def evaluate_with_groq(state):
    """Evaluates student answer using Groq LLM."""
    model_name = state.model if state.model else DEFAULT_GROQ_MODEL  # ✅ Use default model if not provided
    ...
    try:
        ...
        # ✅ Parse output and ensure "score" is used instead of "groq_score"
